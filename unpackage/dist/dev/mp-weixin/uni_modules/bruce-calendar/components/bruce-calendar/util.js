"use strict";
const uni_modules_bruceCalendar_components_bruceCalendar_calendar = require("./calendar.js");
class Calendar {
  constructor({
    date,
    selected,
  ...
  getlunar(year, month, date) {
    return uni_modules_bruceCalendar_components_bruceCalendar_calendar.calendar.solar2lunar(year, month, date);
  }
  /**
   * 设置打点
   */
