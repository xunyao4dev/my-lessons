...
const virtualListModule = {
  ...
  methods: {
    ...
    _setCellIndex(list, dataFrom = "bottom") {
      ...
      const cellIndexKey = this.virtualCellIndexKey;
      [uni_modules_zPaging_components_zPaging_js_zPagingEnum.Enum.QueryFrom.Refresh, uni_modules_zPaging_components_zPaging_js_zPagingEnum.Enum.QueryFrom.Reload].indexOf(this.queryFrom) >= 0 && this._resetDynamicListState();
